...
/*Relatório de Processo da Astel que passaram pela infra no período 09/06/2025 00:00:00 à 13/06/2025 23:59:59*/
WITH RankedProcesses AS (
    SELECT
        N.NUPROCESSOFORMATADO AS PROCESSO,
        TU.DTENCAMINHA,
...
(SELECT TU_ANT.DTENCAMINHA
 ...
 FETCH FIRST 1 ROWS ONLY) AS DTENCAMINHA_ANTERIOR,
    ...
    LEFT JOIN ECPAORGAOSETOR OS ON TU.CDORGAOTRAMI = OS.CDORGAOSETOR
    WHERE 
        OS.SGORGAOSETOR LIKE '%INFRA%'
        AND (
            (TU.DTRECEBTO IS NULL AND TU.DTENCAMINHA BETWEEN TO_DATE('2025-06-09 00:00:00', 'YYYY-MM-DD HH24:MI:SS') AND TO_DATE('2025-06-13 23:59:59', 'YYYY-MM-DD HH24:MI:SS'))
            OR (TU.DTRECEBTO BETWEEN TO_DATE('2025-06-09 00:00:00', 'YYYY-MM-DD HH24:MI:SS') AND TO_DATE('2025-06-13 23:59:59', 'YYYY-MM-DD HH24:MI:SS')
                AND (SELECT TU_ANT.DTENCAMINHA
                    FROM ECPATRAMITACAO TU_ANT
                    WHERE TU_ANT.NUPROCESSO = TU.NUPROCESSO
                    AND TU_ANT.NUANO = TU.NUANO
                    AND TU_ANT.NUTRAMITE = TU.NUTRAMITE - 1
                    FETCH FIRST 1 ROWS ONLY) BETWEEN TO_DATE('2025-06-09 00:00:00', 'YYYY-MM-DD HH24:MI:SS') AND TO_DATE('2025-06-13 23:59:59', 'YYYY-MM-DD HH24:MI:SS'))
        )
)
SELECT
    PROCESSO,
