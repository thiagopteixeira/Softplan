/*Relação de Processos Tramitados para Usuário Indicado e no Período Indicado*/
...
WITH UltimoEncaminhamento AS (
    ...
    WHERE T.CDUSUARIORECEB = '28080116873'
        -- Filtro de data para limitar o intervalo de encaminhamentos entre 01/01/2021 e 28/02/2025
        AND T.DTENCAMINHA BETWEEN TO_TIMESTAMP('01/01/2021 00:00:00.000', 'DD/MM/YYYY HH24:MI:SS.FF3') 
        AND TO_TIMESTAMP('28/02/2025 17:45:59.999', 'DD/MM/YYYY HH24:MI:SS.FF3')
)
